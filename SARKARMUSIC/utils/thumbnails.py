...
async def get_thumb(videoid):
    ...
    arial = ImageFont.truetype("SARKARMUSIC/assets/assets/font2.ttf", 30)
    font = ImageFont.truetype("SARKARMUSIC/assets/assets/font.ttf", 30)
    title_font = ImageFont.truetype("SARKARMUSIC/assets/assets/font3.ttf", 45)
    ...
    play_icons = Image.open("SARKARMUSIC/assets/assets/BABYMUSICPNG.png")
